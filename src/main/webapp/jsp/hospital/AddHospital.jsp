...
<%--         <%
    ...
    HospitalServcie hservServcie=new HospitalServiceImpl();
    Hospital hospital=new Hospital();
    
    
    
    if (hospitalName != null && city != null && address != null && email != null ) {
    	hospital.setHospitalname(hospitalName);
    	hospital.setHospitalCity(city);
    	hospital.setHospitalAddress(address);
    	hospital.setHospitalPincode(zipCode);
    	hospital.setHospitalEmail(email);
    	hospital.setHospitalPhno(phone);
    	String message=hservServcie.addHospital(hospital);
